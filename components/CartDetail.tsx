...
function CartDetail({ cartItems }: Props) {
  ...
  const cachedGetTotalPrice = useMemo(
  ...
  return (
    <>
      <h2 className="text-2xl sm:text-4xl mt-3 mb-2 sm:mb-5 font-bold">
        Order summary
      </h2>
      ...
      <div className="mb-5">
        ...
        <select
          className="w-full p-4 mt-3 text-gray-600"
          value={shippingCost}
          onChange={(event) => {
      ...
      <div className="mb-5">
        ...
        <input
          type="text"
          className="w-full bg-gray-200 p-4 mt-3 text-gray-600"
